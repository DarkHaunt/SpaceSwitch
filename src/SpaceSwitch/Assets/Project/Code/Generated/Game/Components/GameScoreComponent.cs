...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Enemy.EnemyComponents.Score score { get { return (Code.Gameplay.Features.Enemy.EnemyComponents.Score)GetComponent(GameComponentsLookup.Score); } }
    ...
    public GameEntity AddScore(int newValue) {
        ...
        var component = (Code.Gameplay.Features.Enemy.EnemyComponents.Score)CreateComponent(index, typeof(Code.Gameplay.Features.Enemy.EnemyComponents.Score));
